...
class CreateWebUser extends Migration
{
    ...
    public function up()
    {
        Schema::create('web_user', function (Blueprint $table) {
            ...
            $table->string('about_company',250)->nullable();
            $table->string('company_description',200)->nullable();
            $table->string('website_url',200)->nullable();
            $table->string('cac_number',200)->nullable();
            $table->string('type_of_business',200)->nullable();
            $table->string('year_of_existence',200)->nullable();
            $table->string('phone_of_MD_Chairman',200)->nullable();
            $table->string('email_of_MD_Chairman',200)->nullable();
            $table->string('phone_of_contact_person',200);
            $table->string('email_of_contact_person',200)->nullable();
            $table->string('company_rating',200)->nullable();
