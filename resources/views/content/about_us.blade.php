...
@section('container')
	<div class="container">
        ...
        <div class="row row-col-gap">
            <div class="col-md-8">
                <img class="full-width" src="{{ asset('public/img/960x480.png') }}" alt="Image Alternative text" title="Image Title" />
            </div>
            <div class="col-md-4">
        ...
        <div class="row row-col-gap">
            ...
            <div class="col-md-6">
                <img class="full-width" src="{{ asset('public/img/550x210.png') }}" alt="Image Alternative text" title="Image Title" />
            </div>
        </div>
        <div class="gap gap-small"></div>
        <div class="row row-col-gap">
            <div class="col-md-9">
                <div class="row row-sm-gap" data-gutter="10">
                    <div class="col-md-2">
                        <img class="full-width" src="{{ asset('public/img/300x300.png') }}" alt="Image Alternative text" title="Image Title" />
                    </div>
                    <div class="col-md-2">
                        <img class="full-width" src="{{ asset('public/img/300x300.png') }}" alt="Image Alternative text" title="Image Title" />
                    </div>
