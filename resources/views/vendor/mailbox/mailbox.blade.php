        ...
        <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-content mailbox-content">
                        <div class="file-manager">
                            <a class="btn btn-block btn-primary compose-mail" href="{{ url('vendor/mailbox/mail_compose') }}">Compose Mail</a>
            ...
            <div class="mail-box-header">
                ...
                <tr class="unread">
                    ...
                    <td class="mail-ontact"><a href="{{ url('vendor/mailbox/mail_detail') }}">Anna Smith</a></td>
                    <td class="mail-subject"><a href="{{ url('vendor/mailbox/mail_detail') }}">Lorem ipsum dolor noretek imit set.</a></td>
